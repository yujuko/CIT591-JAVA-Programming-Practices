	...
	public class FileIntro {
		...
		public static void main(String[] args) {
			...
			File inputFile = new File("/Users/lucykuo/eclipse-workspace/Class13Oct11/MCITCourseNumbers.txt");
			File outputFile = new File("/Users/lucykuo/eclipse-workspace/Class13Oct11/MCITCourseNames.txt");
...
//			File outputFile = new File("MCITCourseNames.txt");
			...
			try {
				...
				fe.printStackTrace();//give you more information than System.out.print("fe);
			}
		}
